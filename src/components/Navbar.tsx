      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-18">
          ...
          <div className="hidden sm:flex items-center gap-3">
            <a
              href={`tel:${hospitalInfo.phone.replace(/\s+/g, '')}`}
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg border border-slate-300 text-slate-700 hover:border-slate-400 hover:bg-slate-50 text-sm font-medium transition-all"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-teal-600 hover:bg-teal-700 text-white text-sm font-semibold shadow-sm shadow-teal-600/30 hover:shadow-teal-600/40 hover:-translate-y-0.5 transition-all"
            >
            ...
            {currentUser ? (
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                ...
                <button
                  ...
                  className="py-2 text-center text-xs font-semibold text-teal-700 bg-teal-50 border border-teal-200 rounded-lg flex items-center justify-center gap-1"
                >
